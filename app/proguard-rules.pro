...
#业务类库
-keep class com.axzl.mobile.refueling.mvp.model.entity.** {*;}                                      #实体类不要混淆
-dontwarn com.axzl.mobile.refueling.mvp.model.entity.**

-keep class com.jess.arms.cj.** {*;}                                                                #实体类不要混淆
-dontwarn com.jess.arms.cj.**

-keep class com.jess.arms.base.BaseApplication {*;}
-keep class com.axzl.mobile.refueling.app.global.GlobalConfiguration {*;}                           #类不要混淆
-keep class com.axzl.mobile.refueling.app.utils.AppCrashHandler {*;}                                #类不要混淆
-keep class com.axzl.mobile.refueling.app.global.AccountManager {*;}                                #类不要混淆
-keep class com.axzl.mobile.refueling.app.global.RequestMapper {*;}                                 #类不要混淆
-keep interface com.axzl.mobile.refueling.app.global.Constant {*;}                                  #类不要混淆
...
-keep class com.axzl.mobile.refueling.fragment.*LogisticsMainHomeFragment
-keep class com.axzl.mobile.refueling.fragment.*MainLeftFragment
-keep class com.axzl.mobile.refueling.fragment.*SalesMainHomeFragment
-keep class com.axzl.mobile.refueling.fragment.*UnauthorizedFragment
-keep class com.axzl.mobile.refueling.utils.FileLoggingTree
-keep class com.axzl.mobile.refueling.activity.BaiduNaviMainActivity
-keep class com.axzl.mobile.refueling.activity.BNDemoGuideActivity
...
#防止inline
-dontoptimize
-keep class com.axzl.mobile.refueling.app.global.SophixStubApplication {*;}          					 #类不要混淆
# 如果不使用android.support.annotation.Keep则需加上此行
-keep class com.axzl.mobile.refueling.app.global.SophixStubApplication$RealApplicationStub
##----------------------------------------------
...
-keep class com.axzl.mobile.refueling.service.JPushReceiver {*;}	                				#类不要混淆
-keep class com.axzl.mobile.refueling.service.JPushReceiver

 ...
 * ================================================
 */
public class FontAwesomeItemHolder extends BaseHolder<FontAwesome.Icon> {
    ...
    public FontAwesomeItemHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void setData(@NonNull FontAwesome.Icon data, int position) {

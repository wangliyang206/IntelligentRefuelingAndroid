 ...
 * ================================================
 */
public class OcticonsItemHolder extends BaseHolder<Octicons.Icon> {
    ...
    public OcticonsItemHolder(View itemView) {
        super(itemView);
    }

    @Override
    public void setData(@NonNull Octicons.Icon data, int position) {

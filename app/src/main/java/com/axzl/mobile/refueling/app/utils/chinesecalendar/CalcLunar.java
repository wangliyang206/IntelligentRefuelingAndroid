package com.axzl.mobile.refueling.app.utils.chinesecalendar;
...
import static com.axzl.mobile.refueling.app.utils.chinesecalendar.Consts.ganStr;
import static com.axzl.mobile.refueling.app.utils.chinesecalendar.Consts.nStr1;
import static com.axzl.mobile.refueling.app.utils.chinesecalendar.Consts.nStr2;
...
public class CalcLunar {
    ...
    public String GanZhiYearString(int _cYear) {
        String tempStr;
        int i = (_cYear - Consts.GanZhiStartYear) % 60; //计算干支
        tempStr = ganStr.substring(i % 10, i % 10 + 1) +
    ...
    public String GanZhiDayString(Date _date) {
        ...
        int i, offset;
        offset = CommonUtils.daysBetween(_date, Consts.GanZhiStartDay);

        i = offset % 60;
        String tempStr = ganStr.substring(i % 10, i % 10 + 1) +
    ...
    public String AnimalString(Date _date) {
        int offset = CommonUtils.yearDateDiff(_date, Consts.AnimalStartYear); //阳历计算
    ...
    public String ChineseYearString(int _cYear) {
        ...
        String num = _cYear + "";
        for (int i = 0; i < 4; i++) {
            tempStr += CommonUtils.ConvertNumToChineseNum(num.toCharArray()[i]);
        }
        return tempStr + "年";
    ...
    public String GetChineseHour(Date dt, Date _date) {
        ...
        //计算天干
        int ts = CommonUtils.daysBetween(_date, Consts.GanZhiStartDay);
        i = ts % 60;
...
//            System.out.println(y + "  " + sdf.format(basecalendar.getTime()));
    ...
    public String ChineseConstellation(Date _date)
    {
        ...
        offset =CommonUtils.daysBetween( _date ,Consts. ChineseConstellationReferDay);

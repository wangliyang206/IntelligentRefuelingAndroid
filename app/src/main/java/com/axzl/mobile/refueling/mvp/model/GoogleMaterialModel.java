 ...
 */
@ActivityScope
public class GoogleMaterialModel extends BaseModel implements GoogleMaterialContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public GoogleMaterialModel(IRepositoryManager repositoryManager) {
